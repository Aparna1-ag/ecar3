                            ...
                            <table class="allTables table align-items-center justify-content-center ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 d-flex-column justify-content-center align-content-center">User Role</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex px-2 ">
                                                    <h6 class="mb-0 text-sm"><?php echo $row['phone_no'] ?></h6>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 ">
                                            ...
                                            <a href="#" class="btn btn-link" data-toggle="modal" data-target="#editModal" onclick="populateEditModal(this)" data-user-id="<?php echo $row['user_id']; ?>" data-full-name="<?php echo $row['fullname']; ?>" data-email-id="<?php echo $row['email_id']; ?>" data-phone-no="<?php echo $row['phone_no']; ?>">
    <i class="fas fa-user-edit" style="color: #7a4edf;"></i>
</a>
                                                    <a class="btn btn-link" title="Delete" href="#" data-toggle="modal" data-target="#deleteModal" data-user-id="<?php echo $row['user_id']; ?>">
...
<script>
    $('#deleteModal').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget);
        var userId = button.data('user-id');
        $('#confirmDeleteButton').attr('href', '?delete_user=delete_user&admin_id=' + userId);
    });
</script>
...
<script>
    ...
    function submitPasswordForm() {
        ...
        $('#passwordForm').submit();
                    ...
                    <?php
                    $sql = "SELECT password FROM accounts where user_id = $user_id";
