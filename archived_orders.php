...
<div class=" mb-5 mt-2 container d-flex justify-content-center py-2 container  bg-gradient shadow-lg text-uppercase" style="background: #722424"><h2 class="m-auto text-light"  style="font-weight: 400" >Archived Orders Tab</h2> </div>

<div class="row">
      <div class="col-11 m-auto">
        <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="pb-3">Archived Orders</h5>
            <div>
...
<div class=" px-0 pt-0 pb-2">
            ...
            <table class="table shadow-lg table-bordered table-sm" id="dataTable" name="dataTable" style="border: 1px solid white">
                  ...
                  <tr class="bg-gradient  text-light my-2 text-center" style= "background: #722424">
                    ...
                    <tr style="height: 5rem;">
                      ...
                      <td class="align-middle d-flex align-content-center justify-content-center pt-4 "  >
                        <a href="viewpurchase.php?purchase_id=<?php echo $row['purchase_id']; ?>" class="ms-3  btn btn-primary btn-sm">
                          ...
                          <a href="procurement.php" class="ms-3 btn btn-warning btn-sm ">
                          Move back to Procurement tab </a>
