...
$pdf->Write(0, 'ELECTRICAL QMS - ORDER NO: ' . $unit, '', 0, 'L', true, 0, false, false, 0);
...
<table border="1" cellpadding="5" cellspacing="2" nobr="true">
 ...
 <tr>
 <td width="50px">1</td>
  <td width="200px">ELECTRICAL CONNECTIONS</td>
 ...
 <td>Australian Electrician Certified.</td>
 <td>$yescheckBox3</td>
 <td>$remark3</td>
</tr>
 <tr>
...
$outputFolder = 'QMSElectricalfolder';
...
$pdfFilePath = $outputFolder . '/OrderNo' . $oodo_order_id . '-ElectricalQMS .pdf';
