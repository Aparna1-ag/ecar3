...
$pdf->Write(0, 'FINAL QMS - ORDER NO: ' . $unit, '', 0, 'L', true, 0, false, false, 0);
...
<table border="1" cellpadding="5" cellspacing="2" nobr="true">
 ...
 <tr>
 <td width="50px">1</td>
  <td width="200px">COUPLING, SAFETY CHAIN AND  OTHER COMPONENTS</td>
  <td>Shall confirm to the Approved components data.</td>
  <td>$yescheckBox1</td>
  <td>$remark1</td>
 </tr>
 <tr>
  ...
  <td>Shall confirm to Mechanical installation checklist.</td>
  <td>$yescheckBox2</td>
  <td>$remark2</td>
 </tr>
 <tr>
  ...
  <td>Shall confirm to Electrical Installation Checklist.</td>
  <td>$yescheckBox3</td>
  <td>$remark3</td>
 </tr>
 <tr>
...
$pdfFilePath = $outputFolder . '/OrderNo' . $oodo_order_id . '-QMS_Form_Data.pdf';
$pdf->Output(__DIR__ . DIRECTORY_SEPARATOR . $pdfFilePath, 'F');

// Redirect the user to another page

include './google-drive/QCUpload.php';
